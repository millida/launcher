...
целые темы: в комплекте «Минимал», «Марио», «Windows 98» и «Терминал». У каждой
свои настройки прямо в лаунчере — мир и цвет кирпича у «Марио», цвет заголовка и
объёмные рамки у «Windows 98». Рядом — плотность интерфейса: в режиме «Плотно» на
